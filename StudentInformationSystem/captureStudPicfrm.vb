...
Public Class captureStudPicfrm
    ...
    Private Sub captureStudPicfrm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub captureStudpicCMD_Click(sender As Object, e As EventArgs) Handles captureStudpicCMD.Click
        ...
        addStudfrm.studpicPB.Image = capturedPB.Image
    End Sub
